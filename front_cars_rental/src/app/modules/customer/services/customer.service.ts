...
export class CustomerService {
  ...
  bookACar(bookACar: any): Observable<any> {
    return this.http.post(`${BASIC_URL}/api/customer/car/book-and-pay`, bookACar, {
      headers: this.createAuthorizationHeader()
    });
  }
  ...
  getReservedDates(carId: number): Observable<any> {
    return this.http.get(`${BASIC_URL}/api/customer/car/${carId}/reserved-dates`, {
      headers: this.createAuthorizationHeader()
    });
  }

  cancelBooking(bookingId: number): Observable<void> {
    return this.http.delete<void>(`${BASIC_URL}/api/customer/car/cancel-booking/${bookingId}`, {
      headers: this.createAuthorizationHeader()
    });
  }
